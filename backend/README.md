...
## Project Structure
    ...
    ├── testapiautoteammemb_92329  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_92329`
...
2. Clone this repo and `cd testapiautoteammemb_92329`
